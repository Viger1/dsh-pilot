...
Do not open a public issue for a security problem (sandbox escape, credential exposure, origin-fence or approval bypass). Use GitHub's private vulnerability reporting on this repository instead.
...
请**不要**为安全问题（沙箱逃逸、凭证泄漏、域名围栏绕过、审批绕过）开公开 issue，改用本仓库的 GitHub 私密漏洞报告功能。
